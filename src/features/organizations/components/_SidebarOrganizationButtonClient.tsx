...
import { ArrowLeftRight, BuildingIcon, ChevronsUpDown, CreditCardIcon, LogOutIcon, SettingsIcon, UserIcon } from "lucide-react";
    ...
    <DropdownMenu>
      ...
      >
        ...
        <DropdownMenuItem onClick={() => {
          ...
          <BuildingIcon className="mr-2" /> Manage Organization
        </DropdownMenuItem>
        ...
        <DropdownMenuItem asChild>
          <Link href="/organization/select">
            <ArrowLeftRight className="mr-2" /> Switch Organization
          </Link>
        </DropdownMenuItem>
        <DropdownMenuSeparator />
        <SignOutButton>
  ...
  return (
    <div className="flex items-center gap-2 overflow-hidden">
      ...
      <div className="flex flex-col flex-1 min-w-0 leading-tight group-data-[state=collapsed:hidden">
        ...
        <span className="truncate text-xs text-xs">{user.email}</span>
      </div>
    </div>
  );
}
